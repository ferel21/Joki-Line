  ...
  return (
    <section className="relative text-center py-24 sm:py-32 md:py-40 px-4 sm:px-6 lg:px-8 overflow-hidden bg-brand-dark">
      ...
      <div className="relative z-10">
        ...
        >
          Tenang, <span className="font-semibold text-white">Joki Line 2000</span> hadir sebagai solusi andalan untuk semua tugas kuliah dan sekolahmu. Cepat, terpercaya, dan anti-pusing!
        </p>
